...
// $product_name = $product_author = $product_image = $product_price = $product_quantity = "";
 ...
 <head>
 	...
 	<title>Shop: Historical - BookWorms</title>
 ...
 <body>
 	...
 	<div class="heading">
 		...
 		<h3>historical</h3>
 		<p><a href="home_page.php">home</a> / <a href="shop.php">shop</a> / historical </p>
 	...
 	<section class="products">
 		...
 		<div class="box-container">
 			...
 			$select_products = mysqli_query($conn, "SELECT * FROM Products WHERE Category = 'Historical'") or die("Query Unsuccessful!");
