...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 <head>
 	...
 	<title>Shop: Crime & Thriller - BookWorms</title>
 ...
 <body>
 	...
 	<section class="products">
 		...
 		<div class="box-container">
 			...
 			$select_products = mysqli_query($conn, "SELECT * FROM Products WHERE Category = 'Crime & Thriller'") or die("Query Unsuccessful!");
