 ...
 <body>
 	...
 	<section class="search-form">
 		...
 		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
 			<input class="box" type="text" name="search" placeholder="search by product name, author...">
 	...
 	<section class="products">
 		...
 		<div class="box-container">
 			...
 			if(isset($_POST['submit'])){
				...
				$search_item = test_input($_POST['search']);
 				$select_products = mysqli_query($conn, "SELECT * FROM Products WHERE Name LIKE '%{$search_item}%' OR Author LIKE '%{$search_item}%'") or die('Query Unsuccessful!');
